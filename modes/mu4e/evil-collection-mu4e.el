...
(defun evil-collection-mu4e-set-bindings ()
	...
	;; `evil-define-key'.
	(evil-collection-inhibit-insert-state 'mu4e-main-mode-map)
	(evil-set-initial-state 'mu4e-main-mode 'normal)
	(evil-collection-inhibit-insert-state 'mu4e-headers-mode-map)
	(evil-set-initial-state 'mu4e-headers-mode 'normal)
	(evil-collection-inhibit-insert-state 'mu4e-view-mode-map)
