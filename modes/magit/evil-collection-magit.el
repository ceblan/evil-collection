  ...
  (let ((states (if evil-collection-magit-use-y-for-yank
    ...
    (append
     `((,states magit-mode-map "g")
       ...
       (,states magit-mode-map "_"     magit-revert                   "R")
       (,states magit-mode-map "V"     magit-svn                      "V")
       (,states magit-diff-mode-map  "t"     scroll-up                "t")
       (,states magit-log-mode-map   "t"     scroll-up                "t")
       (,states magit-diff-mode-map  "T"     scroll-down              "T")
       (,states magit-log-mode-map   "T"     scroll-down              "T")
